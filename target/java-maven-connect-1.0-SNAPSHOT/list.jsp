...
<head>
    ...
    <script>
        function changePageSize(pageSize){
            location.href="query_contact?pageSize="+pageSize;
        }
    </script>
    <style type="text/css">
        td, th {
        ...
        <tr>
            <td colspan="8" align="center" class="form-inline">
                <C:forEach begin="${beginPage}" end="${endPage}" var="idx">
                    ...
                    <a class="btn btn-default ${currentPage == idx ? 'btn-success' : ''}" href="query_contact?currentPage=${idx}&pageSize=${pageSize}">${idx}</a>
                </C:forEach>
